...
% Sections
    \cvsection{SUMMARY}{
        Gameplay Programmer experienced in Unreal Engine and Unity, focused on scalable systems and clean architecture, 
        developing modular frameworks for published titles while collaborating with teams, adapting to workflows, and working independently with self-motivation and ambition.
    }
    ...
    \cvsection{SKILLS}{
        \begin{itemize}[noitemsep, topsep=0pt, parsep=0pt, partopsep=0pt, itemsep=0pt, leftmargin=*]
            ...
            \item \textbf{Unreal C++ / Netcode} – Developed games with custom replication, networking and multiplayer support in Unreal and using \textbf{Mirror} in Unity.
